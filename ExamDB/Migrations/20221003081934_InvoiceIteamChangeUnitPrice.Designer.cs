...
namespace ExamDB.Migrations
{
    ...
    [Migration("20221003081934_InvoiceIteamChangeUnitPrice")]
    partial class InvoiceIteamChangeUnitPrice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamDB.Models.Album", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Artist", b =>
                {
                    b.Property<long>("ArtistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExamDB.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Genre", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.MediaType", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Playlist", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Models.Track", b =>
                {
                    b.Property<long>("TrackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExamDB.Models.Album", b =>
                {
                    b.HasOne("ExamDB.Models.Artist", "Artist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("ExamDB.Models.Customer", b =>
                {
                    b.HasOne("ExamDB.Models.Employee", "SupportRep")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("ExamDB.Models.Employee", b =>
                {
                    b.HasOne("ExamDB.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("ExamDB.Models.Invoice", b =>
                {
                    b.HasOne("ExamDB.Models.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ExamDB.Models.InvoiceItem", b =>
                {
                    b.HasOne("ExamDB.Models.Invoice", "Invoice")
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .IsRequired();

                    b.HasOne("ExamDB.Models.Track", "Track")
                        .WithMany("InvoiceItems")
            ...
            modelBuilder.Entity("ExamDB.Models.Track", b =>
                {
                    b.HasOne("ExamDB.Models.Album", "Album")
                        .WithMany("Tracks")
                        .HasForeignKey("AlbumId");

                    b.HasOne("ExamDB.Models.Genre", "Genre")
                        .WithMany("Tracks")
                        .HasForeignKey("GenreId");

                    b.HasOne("ExamDB.Models.MediaType", "MediaType")
                        .WithMany("Tracks")
            ...
            modelBuilder.Entity("PlaylistTrack", b =>
                {
                    b.HasOne("ExamDB.Models.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistId")
                        .IsRequired();

                    b.HasOne("ExamDB.Models.Track", null)
                        .WithMany()
                        .HasForeignKey("TrackId")
                        .IsRequired();
                });
