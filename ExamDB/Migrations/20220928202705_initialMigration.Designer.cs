...
namespace ExamDB.Migrations
{
    ...
    [Migration("20220928202705_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamDB.Album", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Artist", b =>
                {
                    b.Property<long>("ArtistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExamDB.Customer", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Employee", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Genre", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Invoice", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.MediaType", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Playlist", b =>
                {
            ...
            modelBuilder.Entity("ExamDB.Track", b =>
                {
                    b.Property<long>("TrackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ExamDB.Customer", b =>
                {
                    b.HasOne("ExamDB.Employee", "SupportRep")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("ExamDB.Employee", b =>
                {
                    b.HasOne("ExamDB.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("ExamDB.Invoice", b =>
                {
                    b.HasOne("ExamDB.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ExamDB.InvoiceItem", b =>
                {
                    b.HasOne("ExamDB.Invoice", "Invoice")
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .IsRequired();

                    b.HasOne("ExamDB.Track", "Track")
                        .WithMany("InvoiceItems")
            ...
            modelBuilder.Entity("ExamDB.Track", b =>
                {
                    b.HasOne("ExamDB.Album", "Album")
                        .WithMany("Tracks")
                        .HasForeignKey("AlbumId");

                    b.HasOne("ExamDB.Genre", "Genre")
                        .WithMany("Tracks")
                        .HasForeignKey("GenreId");

                    b.HasOne("ExamDB.MediaType", "MediaType")
                        .WithMany("Tracks")
            ...
            modelBuilder.Entity("PlaylistTrack", b =>
                {
                    b.HasOne("ExamDB.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistId")
                        .IsRequired();

                    b.HasOne("ExamDB.Track", null)
                        .WithMany()
                        .HasForeignKey("TrackId")
                        .IsRequired();
                });
